...
\begin{center}
    \textbf{\Huge \scshape Третьяков Даниил} \\ \vspace{1pt}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Настроил \emph{Yandex DataLens} для агрегации, визуализации и анализа пользовательской статистики с целью повышения качества сервиса;}
            \resumeItem{Настроил \emph{Nginx} как reverse proxy для приёма событий через webhook, что удвоило скорость их обработки;}
            \resumeItem{Используя \emph{Docker Compose}, спроектировал и реализовал многоконтейнерную систему, снизив время развёртывания проекта на новом сервере до 1 минуты;}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
...
\section{Дополнительные знания и навыки}
    \resumeSubHeadingListStart
        \resumeProjectHeading
            {\textbf{Уровень владения английским языком: Upper Intermediate (B2)} $|$ \emph{Сертификат СПбГУ}}{\emph{Июль 2022}}    
        \resumeProjectHeading
            {\textbf{Математическая статистика} $|$ \emph{\href{https://stepik.org/cert/2197375}{Сертификат Computer Science Center}}}{\emph{Октябрь 2023}}
        \resumeProjectHeading
            {\textbf{Математический анализ} $|$ \emph{\href{https://stepik.org/cert/2202369}{Сертификат Computer Science Center}}}{\emph{Октябрь 2023}}
        \resumeProjectHeading
            {\textbf{Линейная алгебра} $|$ \emph{\href{https://stepik.org/cert/2378334}{Сертификат Computer Science Center}}}{\emph{Март 2024}}
        \resumeProjectHeading
            {\textbf{Теория вероятностей} $|$ \emph{\href{https://stepik.org/cert/2378334}{Сертификат Computer Science Center}}}{\emph{Август 2024}}
        \resumeProjectHeading
            {\textbf{Введение в соревновательный Data Science} $|$ \emph{\href{https://stepik.org/cert/2378334}{Сертификат Stepik}}}{\emph{Август 2024}}
    \resumeSubHeadingListEnd
